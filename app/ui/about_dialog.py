...
class AboutDialog(QtWidgets.QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self._window_title = "About %s" % (app.APPLICATION_NAME,)
        self._title = "%s %s" % (app.APPLICATION_NAME, app.__version__,)
        self._description = "Copyright © %s.\nAll rights reserved." % (app.COPYRIGHT,)
    ...
    def __ui__(self):
        ...
        self._ui_btn_report = QtWidgets.QPushButton("Web-page")
