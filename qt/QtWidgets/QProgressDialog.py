...
class QProgressDialog(QtWidgets.QDialog):
    ...
    def __ui__(self):
        ...
        self._ui_cancel_btn.setCursor(QtCore.Qt.CursorShape.ArrowCursor)
        ...
        self._ui_layout.addWidget(self._ui_title, 1, QtCore.Qt.AlignmentFlag.AlignBottom)
        self._ui_layout.addWidget(self._ui_progress, 0, QtCore.Qt.AlignmentFlag.AlignVCenter)
    ...
    def resizeEvent(self, event):
        ...
        self._ui_icon.move(12, round(rect.height() / 2 - icon_rect.height() / 2 - 2))

        self._ui_cancel_btn.move(rect.width() - btn_rect.width() - 12,
                                 round(rect.height() / 2 - btn_rect.height() / 2))
    ...
    def setIcon(self, icon):
        ...
        if isinstance(icon, QtGui.QIcon):
            ...
            self._icon = QtWidgets.QApplication.style().standardIcon(QtWidgets.QStyle.StandardPixmap.SP_MessageBoxInformation)\
                .pixmap(size)
